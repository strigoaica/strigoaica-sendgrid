...
var Sendgrid = /** @class */ (function () {
    ...
    Sendgrid.prototype.send = function (templateId, data) {
        return __awaiter(this, void 0, void 0, function () {
            var recipients, mailOptions;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) { return sendgridMail
                        .send(mailOptions)
    ...
    Sendgrid.prototype.loadLocalTemplateOptions = function (templateId) {
        ...
        var meta = strigoaica_strategy_1.Strategy.extractMergeValueMeta(rawTemplate);
        return {
